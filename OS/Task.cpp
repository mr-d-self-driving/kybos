...
void Task::run() {
	long result = xTaskCreate(&taskfunwrapper, ( const char * ) _name, _stackSize, this, _priority, &_hnd);
...
{
	xTaskCreate(&taskfunctorwrapper, ( const char * ) name, stackSize, functor, priority, 0);
}
